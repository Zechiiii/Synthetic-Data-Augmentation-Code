"""Build the retrospective admission-level hospital-mortality dataset.

Features summarize available measurements in the first 120 hours after admission.
``hosp_mortality`` is any in-hospital death during that admission; it is not a
post-120-hour outcome or a landmark-prediction target.
"""
import numpy as np
import pandas as pd
import duckdb
...
output_path = SCRIPT_DIR / "mortality.csv"
