"""Build the retrospective admission-level ICD-coded sepsis dataset.

Features summarize available measurements in the first 120 hours after admission.
``sepsis`` is a discharge diagnosis of severe sepsis (ICD-9 99592) or septic
shock (ICD-9 78552). This is retrospective identification, not onset prediction.
"""
import numpy as np
import pandas as pd
import duckdb
...
output_path = SCRIPT_DIR / "sepsis.csv"
